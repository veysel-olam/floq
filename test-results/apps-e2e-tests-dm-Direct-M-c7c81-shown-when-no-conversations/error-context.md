...
- Name: apps/e2e/tests/dm.spec.ts >> Direct Messages >> empty state shown when no conversations
- Location: apps/e2e/tests/dm.spec.ts:16:7
...
Call log:
  - navigating to "/dm", waiting until "load"
