...
- Name: apps/e2e/tests/profile.spec.ts >> Profile >> notifications page loads
- Location: apps/e2e/tests/profile.spec.ts:29:7
...
Call log:
  - navigating to "/notifications", waiting until "load"
