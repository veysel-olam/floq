...
- Name: apps/e2e/tests/features.spec.ts >> Interview Mode >> interview page loads
- Location: apps/e2e/tests/features.spec.ts:32:7
...
Call log:
  - navigating to "/interview", waiting until "load"
