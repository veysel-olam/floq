...
- Name: apps/e2e/tests/network.spec.ts >> Network Map >> zoom controls are visible when graph loads
- Location: apps/e2e/tests/network.spec.ts:21:7
...
Call log:
  - navigating to "/network", waiting until "load"
