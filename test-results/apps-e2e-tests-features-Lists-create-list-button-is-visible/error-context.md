...
- Name: apps/e2e/tests/features.spec.ts >> Lists >> create list button is visible
- Location: apps/e2e/tests/features.spec.ts:25:7
...
Call log:
  - navigating to "/lists", waiting until "load"
